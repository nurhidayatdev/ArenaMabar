      ...
      <div className="max-w-5xl mx-auto w-full flex flex-col items-center text-center z-10 px-4 sm:px-6 flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl">
            ...
            >
              <div className="w-14 h-14 bg-indigo-200 dark:bg-indigo-800/80 border-2 border-slate-900 dark:border-slate-100 rounded-2xl rotate-3 mb-5 flex items-center justify-center">
                <MapPin className="w-7 h-7 text-indigo-700 dark:text-indigo-200 stroke-[2.5]" />
              </div>
            ...
            >
               <div className="w-14 h-14 bg-amber-200 dark:bg-amber-800/80 border-2 border-slate-900 dark:border-slate-100 rounded-2xl -rotate-3 mb-5 flex items-center justify-center">
                <Calculator className="w-7 h-7 text-amber-700 dark:text-amber-200 stroke-[2.5]" />
              </div>
            ...
            >
              <div className="w-14 h-14 bg-teal-200 dark:bg-teal-800/80 border-2 border-slate-900 dark:border-slate-100 rounded-2xl rotate-3 mb-5 flex items-center justify-center">
                <HeartPulse className="w-7 h-7 text-teal-700 dark:text-teal-200 stroke-[2.5]" />
              </div>
        ...
        <section className="w-full flex flex-col items-center bg-amber-200 dark:bg-zinc-900 text-slate-900 dark:text-slate-100 rounded-[32px] p-8 md:p-10 border-4 border-slate-900 dark:border-slate-100 shadow-[8px_8px_0px_0px_rgba(15,23,42,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] mb-16 sm:mb-20 transition-colors">
          ...
          <div className="flex flex-col md:flex-row gap-6 w-full">
            {[
              { title: t("landing.steps.step1.title"), desc: t("landing.steps.step1.desc"), icon: MapPin, bg: "bg-blue-300 dark:bg-blue-500", cardBg: "bg-blue-50 dark:bg-blue-900/40" },
              { title: t("landing.steps.step2.title"), desc: t("landing.steps.step2.desc"), icon: CheckCircle2, bg: "bg-emerald-300 dark:bg-emerald-500", cardBg: "bg-emerald-50 dark:bg-emerald-900/40" },
              { title: t("landing.steps.step3.title"), desc: t("landing.steps.step3.desc"), icon: Calculator, bg: "bg-fuchsia-300 dark:bg-fuchsia-500", cardBg: "bg-fuchsia-50 dark:bg-fuchsia-900/40" }
            ].map((step, idx) => (
              <div key={idx} className={`flex-1 flex flex-col items-center text-center p-6 rounded-[24px] border-4 border-slate-900 dark:border-slate-100 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(15,23,42,1)] dark:hover:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] transition-all ${step.cardBg}`}>
                ...
                <div className="w-8 h-8 rounded-full bg-slate-900 dark:bg-zinc-800 text-white dark:text-slate-100 font-black flex items-center justify-center mb-3 text-sm">
                  {idx + 1}
                </div>
                <h3 className="text-xl font-black mb-2 text-slate-900 dark:text-slate-100">{step.title}</h3>
                <p className="text-slate-700 dark:text-slate-300 font-bold text-sm leading-relaxed">{step.desc}</p>
              </div>
            ))}
          </div>
        </section>
